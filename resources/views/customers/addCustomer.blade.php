                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('new-customer') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="regCode" type="text" class="form-control @error('regCode') is-invalid @enderror" name="regCode" value="{{ old('regCode') }}" required autocomplete="regCode" autofocus>
                                    @error('regCode')
