            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        ...
                        <a href="{{route('add-customer')}}" class="btn btn-sm btn-neutral">New</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="table-responsive table-list-for">
        ...
        <div class="card">
            <table class="table align-items-center">
                ...
                <tr>
                    <th scope="col" class="sort" data-sort="name">Registration code</th>
                    <th scope="col" class="sort" data-sort="budget">Firstname</th>
                    <th scope="col" class="sort" data-sort="name">Lastname</th>
                        ...
                        <th scope="row">
                            <div class="media align-items-center">
                                <div class="media-body">
                                    <span class="name mb-0 text-sm">{{$customer->regCode}}</span>
                                </div>
                            </div>
                        </th>
                        <td class="budget">
                        ...
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item open-modal" href="#delete" data-toggle="modal" data-id="{{$customer->id}}">Delete</a>
                                </div>
                            </div>
                        </td>
                    </tr>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" id="action_form" action="delete-customer/">
                    @csrf
                    ...
                    <div class="modal-body">
                        <p>Are you sure, what you want to delete the customer ?</p>
                    </div>
